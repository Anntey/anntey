...
- <img alt="Python" width="26px" src="https://cdn.jsdelivr.net/npm/simple-icons@3.4.0/icons/django.svg" />[Sentiment attributor web application with Django & React](https://github.com/Anntey/sentiment-attributor-webapp)
